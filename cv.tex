...
\title{Macroécologie, Ecologie Marine, Modélisation statistique}%, Macroécologie, Sciences marines} % Optional, remove / comment the line if not wanted
\address{466 W 2nd Av.}{Columbus, OH 43201, USA}
\mobile{+1 380 215 7939}
%\phone{+420 737 480 623}
\email{francois.libert.leroy@gmail.com}
\homepage{frslry.github.io/}{https://frslry.github.io/} % The first argument is the url for the clickable link, the second argument is the url displayed in the template - this allows special characters to be displayed such as the tilde in this example
...
\cventry{}{}{}{}{}{Chercheur en écologie quantitative et macroécologie, spécialisé dans l’étude des changements de biodiversité à larges échelles spatio-temporelles. Mon parcours associe une formation en écologie côtière et marine à une expertise en modélisation statistique, télédétection et intelligence artificielle. Je développe actuellement des méthodes de Deep Learning appliquées aux données écologiques au sein du NSF AI and Biodiversity Change Global Center.}

\section{Expériences}

\cventry{2024-2026}{Chercheur postdoctoral - Développement de réseaux de neurones (IA) pour comprendre les changements spatio-temporels de biodiversité}{The Ohio State University}{Columbus, Ohio, USA}{}{
\begin{itemize}
    \item Projet NSF: \href{https://www.biodiversityai.org/}{AI and Biodiversity Change} Global Center 
    \item Développement de réseaux neuronaux hiérarchiques à partir d’un cadre bayésien
    \item Vision par ordinateur (computeur vision) pour l’analyse d’images de terrain et de données satellitaires
    \item Personnalisation de fonctions de perte pour l’inférence des paramètres de distribution
\end{itemize}
}

\cventry{2020-2024}{Doctorat - Échelles spatiales et décomposition des changements macroécologiques}{CZU, département de sciences spatiales}{Prague}{}{
\begin{itemize}
    \item Modélisation spatiales des changements de biodiversité à l’aide de grandes bases de données
    \item Optimisation et sélection de modèles d'apprentisage automatiques (Random Forest, BRT, XGBoost, modèles linéaires...)
...
\cventry{}{}{}{}{}{
\begin{itemize}
    \item Publication dans la revue \href{https://www.science.org/doi/10.1126/science.ads0871}{Science} d'une étude sur l'accélération du déclin des populations aviaires en Amérique du Nord. Repris par de nombreux médias, dont la \href{https://www.nytimes.com/issue/todayspaper/2026/02/27/todays-new-york-times}{première page du New York Times}, le \href{https://www.washingtonpost.com/climate-environment/2026/02/26/bird-populations-dying-farming/}{Washington Post}, \href{https://www.lemonde.fr/planete/article/2026/02/26/en-amerique-du-nord-le-declin-des-oiseaux-s-accelere-avec-l-intensification-de-l-agriculture_6668407_3244.html}{Le Monde}, \href{https://www.wbur.org/onpoint/2026/04/03/america-bird-population-decline}{NPR}, \href{https://apnews.com/article/birds-losses-faster-climate-change-agriculture-8cf053bda9dad4fe2dd5a1c7048b6d39}{Associated Press}...
    \item Determination des erreurs de mesure du satellite ICESat-2 de la NASA (\href{https://doi.org/10.1016/j.rse.2022.113112}{article})
    \item Comparaison des performances de modèles (RF, BRT, XGBoost, GLM) avec validation croisée (\href{https://nsojournals.onlinelibrary.wiley.com/doi/10.1111/ecog.06995}{article})
...
\cventry{2021}{Machine Learning}{Faculté de mathématiques et physique, UFAL, Université Charles}{}{Prague}{Etude de tous les algorithmes d'apprentissage machine, des modèles linéaires aux réseaux de neurones}

\cventry{2020-2024}{Doctorat - Échelles spatiales et décomposition des changements macroécologiques}{}{}{Prague}{}{}

\cventry{2020\\\includegraphics[width=15mm]{pictures/Ifremer.png}}{Modélisation des communautés}{DYNECO-LEBCO, IFREMER}{Brest (France)}{}{
\begin{itemize} 
  \item Développer des outils de modélisation (approches qualitatives et réseaux bayésiens dynamiques) pour évaluer la dynamique des communautés accompagnant les récifs à \textit{Sabellaria alveolata} à partir de grandes bases de données %(\href{http://www.honeycombworms.org/The-REEHAB-Project}{REEHAB project})
...
\cvitem{Avancé}{\Rlogo R, \Git Git, \faPython Python, \QGIS QGIS, \ArcGIS ArcGIS, \LaTeX}
\cvitem{Intermédiaire}{\Shell Shell, \MySQL MySQL}
\cvitem{Débutant}{\Julia Julia, \MATLAB MATLAB}
...
\begin{itemize}
    ...
    \item SIG et analyses spatiales
\end{itemize}
}
...
\cvitem{\textbf{Deep Learning}}{Perceptron multicouche, réseaux convolutifs/récurrents/hiérarchiques}
...
\cventry{Conférencier invité}{\textbf{Introduction to Reproducible Science: Version Control using Git and Github}}{Ecoinformatics IAVS}{Online}{\href{https://frslry.github.io/git_pres/}{Slides}}{%\underline{Content:}
% \begin{itemize}
% \item Spatial scaling of species richness trends
% \item Birds of the Czech Republic
% \item Positive and stronger trend of species richness with increasing spatial scale 
...
\cventry{}{\textbf{Decomposing abundance change to recruitment and loss: analysis of the North-American avifauna}}{Ecological Society of America}{Portland, OR}{\href{https://frslry.github.io/ESA_conf/}{Slides}}{%\underline{Content:}
% \begin{itemize}
% \item Spatial scaling of species richness trends
% \item Birds of the Czech Republic
% \item Positive and stronger trend of species richness with increasing spatial scale 
...
\cventry{}{\textbf{Untangling biodiversity changes across a continuum of spatial scales}}{International Biogeography Society conference}{Vancouver, BC}{\href{https://frslry.github.io/IBS_conf/}{Slides}}{%\underline{Content:}
% \begin{itemize}
% \item Spatial scaling of species richness trends
% \item Birds of the Czech Republic
% \item Positive and stronger trend of species richness with increasing spatial scale 
